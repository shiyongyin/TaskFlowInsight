...
class CompareEngineBoundaryTests {
    ...
    void setUp() {
        ...
        compareEngine = CompareRuntime.builder().build().engine();
    }
    ...
    @Nested
    @DisplayName("CompareEngine — direct core execution")
    class CompareEngineTests {
        ...
        void sameRef() {
            Object o = "x";
            CompareResult r = compareEngine.compare(o, o, CompareOptions.builder().build());
            assertThat(r.isIdentical()).isTrue();
        }
        ...
        void nullDiff() {
            CompareResult r = compareEngine.compare("a", null, CompareOptions.builder().build());
            assertThat(r.isIdentical()).isFalse();
        }
        ...
        void typeDiff() {
            CompareResult r = compareEngine.compare("str", 42, CompareOptions.builder().build());
            assertThat(r.isIdentical()).isFalse();
        }
        ...
        void listRouting() {
            ...
            CompareResult r = compareEngine.compare(l1, l2, CompareOptions.builder().build());
            assertThat(r).isNotNull();
        }
        ...
        void deepFallback() {
            ...
            b.num = 2;
            CompareOptions opts = CompareOptions.builder().build();
            CompareResult r = compareEngine.compare(a, b, opts);
            assertThat(r.getChanges()).isNotEmpty();
        }
