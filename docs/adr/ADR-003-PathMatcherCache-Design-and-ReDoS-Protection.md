...
- 取代日期: 2026-07-12
- 取代者: [ADR-012](ADR-012-Compare-Kernel-And-Collection-Semantics.md)

> 本文保留为历史决策证据。4.0使用immutable policy构建期编译的有界typed pattern，不保留runtime LRU、
> preload、clear或fallback-to-literal状态；当前合同由ADR-012持有。
